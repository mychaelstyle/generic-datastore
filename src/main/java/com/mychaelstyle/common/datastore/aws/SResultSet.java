 ...
 *
 */
public class SResultSet implements com.mychaelstyle.common.GenericDatastore.ResultSet {
     ...
     */
    public SResultSet(JSONObject config, ScanRequest request) throws ConfigurationException{
